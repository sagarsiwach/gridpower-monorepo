/**
 * Settings layout — /settings (parent)
 */
import { NavLink, Outlet } from "react-router";
import { Building2, Users, CreditCard, Key, Bell, ClipboardList, Plug } from "lucide-react";
...
export default function SettingsLayout() {
  return (
    <div className="flex flex-col gap-5">
      <nav aria-label="Settings sections" className="border-b border-border -mx-3 sm:mx-0">
