...
/*
  ...
  Renders the design system in isolation so token decisions
  can be locked visually before page work begins.

  Not a homepage. Not a finished route. A working canvas.
*/
