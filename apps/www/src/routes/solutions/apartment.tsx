          ...
          <div className="lg:grid-cols-2" style={{ display: "grid", gridTemplateColumns: "1fr", gap: 48, alignItems: "center", paddingBlock: 72 }}>
            <Reveal>
              <div>
                ...
                <h1 style={{ fontFamily: 'Inter, ui-sans-serif, system-ui, sans-serif', color: tokens.ink, fontSize: "clamp(34px,5vw,56px)", fontWeight: 600, letterSpacing: "-0.035em", lineHeight: 1.02, marginTop: 16 }}>
