...
export const meta: MetaFunction = () => [
  { title: "GridPower — charge.solutions.home (placeholder)" },
  { name: "robots", content: "noindex" },
];

export default function charge_solutions_homePage() {
  return (
    <main className="mx-auto max-w-7xl px-6 py-32">
      <p className="gp-label-red mb-4">Placeholder route</p>
      <h1 className="font-heading text-h1">charge.solutions.home</h1>
