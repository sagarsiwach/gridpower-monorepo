        ...
        <div className="mx-auto max-w-7xl px-10 pt-8 pb-10 flex gap-2 flex-wrap items-center">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={[
                "px-4 py-1.5 rounded-pill border font-body text-body-sm transition-colors duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
                activeCategory === cat
